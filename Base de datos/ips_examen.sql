...
CREATE TABLE `examen` (
  ...
  `valor_examen` double DEFAULT NULL,
...
INSERT INTO `examen` VALUES (1,'Valoracion',0),(2,'Glucosa',15000),(3,'Radiografia',25000),(4,'Rayos X',35000);
...
-- Dump completed on 2016-11-10 10:29:04
