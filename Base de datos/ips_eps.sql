...
CREATE TABLE `eps` (
  ...
  `direccion_eps` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`cod_eps`)
...
INSERT INTO `eps` VALUES (1,'Sanitas','Cra 7 # 72-15'),(2,'Cafesalud','Auto. Norte # 134-25'),(3,'Nueva EPS','Cll 100 # 15-35'),(4,'Salud Total','Cll 9 # 15-25');
